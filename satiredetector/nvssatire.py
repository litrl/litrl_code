...
#-------------------------------------------------------------------------------
# Name:        nvssatire
# Purpose:     news verification suite satire entry point
#              run this from the browser, not satire.py
#              if you DO NOT have a serialized satire detector (a .dill file in /pickles), please run
#              satire.py first with training sets to obtain this
#
# Created:     01/03/2018
#
...
def main():
    detectorDUMP = open('pickles/satire_detector.dill', 'rb')
